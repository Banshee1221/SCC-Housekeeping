...
iptables -A FORWARD -i $EXTERNAL_NIC -o $INTERNAL_NIC -m state --state RELATED,ESTABLISHED -j ACCEPT
...
printf "==========\n=\n=\n=\n=\n= Make sure that you have run the network setup scripts on the compute nodes at this point\n=\n=\n=\n=\n==========\n"
